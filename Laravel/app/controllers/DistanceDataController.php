...
class DistanceDataController extends \BaseController {
	...
	{
		$body_data=DB::table('distance')
					->get();

		foreach ($body_data as $daily_data) {
			$response["distancedata"][]=[
				"uid"=>$daily_data->uid,"year"=>$daily_data->year,"month"=>$daily_data->month,"day"=>$daily_data->day,"mile"=>$daily_data->mile
	...
	public function show($id)
	{
		...
		foreach ($body_data as $daily_data) {
			$response["distancedata"][]=[
				"year"=>$daily_data->year,"month"=>$daily_data->month,"day"=>$daily_data->day,"mile"=>$daily_data->mile
