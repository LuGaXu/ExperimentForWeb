					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					      	<button type="submit" class="btn btn-danger" id="delete" data-dismiss="modal">删除该条建议</button>
...
//  	 });
    ...
    $("#delete").click(function(){
		...
		xmlHttp.open("POST", "deleteAdvice.php", false);
		xmlHttp.setRequestHeader("Content-Type",
				"application/x-www-form-urlencoded");
		xmlHttp.send("id="+currentId);
    });
	...
	function sign_up_callback(){
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete") {
			...
			if (xmlHttp.status == 200) {
				...
				window.location.href="advice_import.php";
			}
		}
	}
