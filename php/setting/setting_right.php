     		...
     		<div class="col-md-8" style="" id="content">
            	<div  style="margin-top:50px;">
             	...
             	<table class="table table-hover">
                        ...
                        ?>
                        	<tr class='<?php  if($type=="普通用户") echo "primary";
                        		else if($type=='教练') echo "teacher";
                        		else if($type=='医生') echo "doctor"?>'>
                            <td><?php echo $type?></td>
                            <td><?php echo $name?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body"  id="modalbody">
         ...
         <div class="form-group">
             ...
             <div style="margin-top:30px;" class="col-sm-6">
                <select id="hosttype" class="form-control" onChange="updateTable()">
          ...
          <div class="form-group" id="host">           
             <label style="margin-top:30px;" class="col-sm-4 control-label">职位</label>
             <div style="margin-top:30px;" class="col-sm-6">
...
<script>
	...
	$("#commit").click(function(){
		...
		var position=$("#hostposition").val();
		if(type==currentType){
			window.location.href="setting_right.php";
			//$("#myModal").hide();
			return;
		}
		if((type=='医生'||type=='教练')&&position==''){
			alert('医生或教练的职位不能空！');
			return;
		}
 ...
 function openModal(type,name,mail,position){
	...
	if(!truth){
	 ...
	 function updateTable(){
		 var type=$("#hosttype").find("option:selected").text();
		 if((type=='医生'||type=='教练')&&(lastType=='普通用户'||lastType=='系统管理员')){
			 $("#modalbody").css("height","250px");
			 $("#host").show();
		 }else if((lastType=='医生'||lastType=='教练')&&(type=='普通用户'||type=='系统管理员')){
			 $("#host").hide();
			 $("#modalbody").css("height","200px");
		 }
		 lastType=type;
