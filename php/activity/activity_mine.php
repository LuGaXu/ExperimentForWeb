    ...
    <div class="container">
    	<div class="row" >
            ...
            <div id="pill">
                ...
                <li role="presentation"><a href="activity.php">参与活动</a></li>
     		...
     		<div class="col-md-8" id="content" style="top:100px;">
            	<!--活动内容-->
     			<?php 
	     			...
	     			$sql="select * from activity where id in(select aid from activity_member where uid=$uid) order by stop desc;";
	     			$ret = $db->query($sql);
	     			if($ret){
