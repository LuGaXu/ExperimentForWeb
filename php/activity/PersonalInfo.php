    	...
    	<div class="row" >
            ...
            <div id="pill">
     		...
     		<div class="col-md-8" style="" id="content">
            	<form class="form-horizontal" style="font-family:楷体,幼圆;font-size:1.5em;margin-top:30px;">
            		 <div class="form-group">
            			<label for="inputPosition" class="col-sm-2 control-label">用户类型</label>
    					<div class="col-sm-6">
      						<input type="text" class="form-control" id="inputPosition" readonly value='<?php echo $type." ".$position?>' >
   						</div>
                	 ...
                	 <div class="form-group">
    					...
    					<div class="col-sm-6">
      						<input type="text" class="form-control" id="inputName" readonly value='<?php echo $name?>' >
   						</div>
                        <div class="col-sm-4"></div>
 					 </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control col-sm-2" style="margin-left:20px;width: 5%" id="inputMonth" readonly value='<?php echo $birthmonth?>' >
                        <label  class="col-sm-1">月</label>
                    	<input type="text" class="form-control col-sm-2" style="width: 5%" id="inputDay" readonly value='<?php echo $birthday?>' >
                         <label  class="col-sm-1">日</label>
                     </div>
                     <div class="form-group">
                     	<label  for="inputHome" class="col-sm-2 control-label">所在地</label>
                        <div class="col-sm-6">
      						<input type="text" class="form-control" id="inputHome" readonly value='<?php echo $location?>' >
   						</div>
                        <div class="col-sm-4"></div>
                     ...
                     <div class="form-group">
                         ...
                         <div class="col-sm-6">
      						<input type="text" class="form-control" id="inputInterest" readonly value='<?php echo $interest?>' >
   						</div>
                        <div class="col-sm-4"></div>
                     </div>
                     <div class="form-group">
                     	<label  class="col-sm-2 control-label">运动宣言</label>
                        <textarea  rows="4" class="form-control col-sm-5" readonly id="inputMotto" style="margin-left:15px;width:80%;"><?php echo $motto?></textarea>
                     </div>
